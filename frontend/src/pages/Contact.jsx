...
export default function Contact() {
  return (
    <form>
      <div className="flex flex-col items-center justify-center h-172 bg-gray-100">
        <h2 className="text-4xl font-bold mb-8 text-gray-600 text-center">Contacto</h2>
        <p className="text-lg text-gray-700 px-64 text-center">Dejanos tu mensaje o comentario y nos pondremos en contacto con vos a la brevedad.</p>
