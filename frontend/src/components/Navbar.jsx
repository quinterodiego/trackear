...
const navigation = [
  { name: 'Inicio', href: '/', rol: 'user', current: true },
  { name: 'Dashboard', href: '/dashboard', rol: 'user', current: false },
  { name: 'Cursos', href: '/cursos', rol: 'user', current: false },
  { name: 'Nosotros', href: '#', rol: 'user', current: false },
  { name: 'Contacto', href: '#', rol: 'user', current: false },
]
              ...
              <div className="flex space-x-4 justify-center">
                {navigation.map((item) => (
                  <a
                    ...
                    className={'text-gray-600 hover:text-gray-800 hover:text-secondary rounded-md px-3 py-2 text-sm font-medium'}
                  >
                    {item.name}
                  </a>
                ))}
